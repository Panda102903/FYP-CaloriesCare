...
const Cart = () => {
  ...
  const handleApplyPromoCode = () => {
    ...
    setPopupMessage({ visible: true, message: result.message, type: result.success ? "success" : "error" });
    setTimeout(() => setPopupMessage({ visible: false, message: "", type: "" }), 3000); // Ẩn popup sau 3 giây
  };
