...
const StoreContextProvider = (props) => {
    ...
    const applyPromoCode = (code) => {
        ...
        if (matchedDiscount) {
            ...
            return { success: true, message: `Promo code applied! You get ${matchedDiscount > 0 ? matchedDiscount + '%' : 'Free Shipping'}.` };
        } else {
            setDiscount(0);
    ...
    const contextValue = {
        ...
        removeFromCart,
        getTotalCartAmount,
        applyPromoCode, // Hàm áp dụng mã giảm giá
        calculateFinalTotal, // Hàm tính tổng tiền sau giảm giá
        discount, // Giá trị giảm giá hiện tại
        url,
        token,
        setToken,
        clearCart,
